...
echo -e "\e[32m Mod by U to support dhclient and dhcpcd. \e[0m"
echo -e "\e[32m =============================================== \e[0m"
...
case $dhcp_client in
  ...
  "dhcpcd")
    ...
    echo "Add customized script to use dhcpcd hooks of dns refresh."  
  "dhclient")
    echo "Detected dhclient DHCP client."
    echo "Add customized script to use dhclient hooks of dns refresh." 
esac
